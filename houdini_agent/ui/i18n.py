...
_ZH = {
    ...
    'plugin.tab_tools': '工具',
    'plugin.tab_skills': '脚本',
    'plugin.no_tools': '暂无注册工具',
    'plugin.no_skills': '暂无已加载的脚本',
    'plugin.tool_toggle_tip': '启用/禁用此工具',
    'plugin.skill_dir_label': '用户脚本目录',
    'plugin.skill_dir_placeholder': '（未设置，仅使用内置脚本）',
    ...
    'plugin.group_skill': '内置脚本',
    'plugin.group_plugin': '插件工具',
    'plugin.group_user': '用户工具',
    'plugin.group_user_skill': '用户脚本',
}
...
_EN = {
    ...
    'plugin.tab_skills': 'Scripts',
    'plugin.no_tools': 'No tools registered',
    'plugin.no_skills': 'No scripts loaded',
    'plugin.tool_toggle_tip': 'Enable/Disable this tool',
    'plugin.skill_dir_label': 'User Script Dir',
    'plugin.skill_dir_placeholder': '(Not set, using built-in scripts only)',
    ...
    'plugin.group_skill': 'Built-in Scripts',
    'plugin.group_plugin': 'Plugin Tools',
    'plugin.group_user': 'User Tools',
    'plugin.group_user_skill': 'User Scripts',
}
