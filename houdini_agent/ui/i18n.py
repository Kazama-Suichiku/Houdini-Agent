...
_ZH = {
    ...
    'input.resize.tooltip': '拖拽调整输入框高度；双击恢复自动高度',
    'mode.agent': '代理',
    'mode.ask': '询问',
    'mode.plan': '计划',
    ...
    'menu.font': '字体 (Aa)',
    'menu.language': '语言',
    'menu.attach_actions': '附件 / 操作',
    'menu.attach_image': '添加图片',
    'menu.read_network': '读取网络',
    'menu.read_selection': '读取选择',
    'menu.export_train': '导出训练数据',
    ...
    'custom.info': '配置任何兼容 OpenAI API 协议的服务端点。\n例如：LM Studio、vLLM、Text Generation WebUI、其他中转站等。',
    'custom.url_placeholder': 'https://integrate.api.nvidia.com/v1 或 .../v1/chat/completions',
    'custom.key_placeholder': 'sk-xxxx（留空则不发送 Authorization 头）',
    'custom.fetch_models': '从 API 获取可用模型列表',
    'custom.add_model': '手动添加模型',
    'custom.remove_model': '删除选中模型',
    'custom.models': '模型名:',
    'custom.context_length': '上下文长度:',
    'custom.features': '特性:',
    'custom.supports_vision': '支持图片输入',
    'custom.supports_fc': '支持 Function Calling',
    'custom.test': '测试连接',
    'custom.need_url': '⚠ 请先填写 API URL',
    'custom.need_url_plain': '请先填写 API URL。',
    'custom.need_model': '请填写至少一个模型名。',
    'custom.fetching_models': '获取模型列表中...',
    'custom.models_found': '✅ 发现 {} 个模型',
    'custom.no_models': '⚠ 未发现可用模型',
    'custom.connecting': '连接中...',
    'custom.connect_ok': '✅ 连接成功（{}）',
    'dialog.notice': '提示',

    # ===== Clear Chat =====
    'clear.confirm_title': '清空当前会话',
    'clear.confirm_msg': '将清空当前会话历史、上下文、Token 统计和待确认操作，并删除该会话缓存。\n\n继续吗？',
    'clear.confirm_running_msg': '当前会话仍在运行。清空会先停止任务，然后删除当前会话历史和缓存。\n\n继续吗？',
    'clear.empty': '当前会话已经是空的',
    ...
    # ===== Experience Review =====
    'experience.menu_label': '工作流经验',
    'experience.title': '工作流经验审阅',
    'experience.subtitle': '自动从任务上下文提炼可复用知识；审阅后再晋升为长期记忆，避免把思考过程写进去。',
    'experience.always_on': '自动沉淀已开启',
    'experience.extract': '手动提取当前会话',
    'experience.export_curated': '导出精选',
    'experience.export_curated_title': '导出精选经验',
    'experience.export_curated_failed': '导出精选经验失败：{}',
    'experience.export_curated_done': '已导出精选经验：语义 {} 条，策略 {} 条\n{}',
    'experience.refresh': '刷新',
    'experience.scope_all': '全部会话',
    'experience.scope_current': '当前会话',
    'experience.show_rejected': '显示已拒绝',
    'experience.queue_title': '候选队列',
    'experience.queue_meta': '当前显示 {} 条 | 过滤：{}',
    'experience.board_summary': '已加载 {} 条 | 候选 {} | 建议晋升 {} | 已晋升 {} | 已拒绝 {} | 稍后 {}',
    'experience.promote': '晋升',
    'experience.reject': '拒绝',
    'experience.delete_rejected': '删除',
    'experience.later': '稍后',
    'experience.filter_active': '待处理',
    'experience.filter_candidate': '候选',
    'experience.filter_later': '稍后',
    'experience.filter_promoted': '已晋升',
    'experience.filter_rejected': '已拒绝',
    'experience.filter_all': '全部',
    'experience.status_candidate': '候选',
    'experience.status_later': '稍后',
    'experience.status_promoted': '已晋升',
    'experience.status_rejected': '已拒绝',
    'experience.empty_title': '暂无选中候选',
    'experience.empty': '暂无候选经验。系统会在任务结束后自动沉淀，也可以手动提取当前会话。',
    'experience.no_history': '当前会话没有可提取的对话历史。',
    'experience.extracted': '已生成候选经验。',
    'experience.extracted_count': '已生成 {} 条候选经验。',
    'experience.promoted': '已晋升为长期记忆。\n\nMemory ID: {}\n详情: {}',
    'experience.promoted_inline': '已晋升为长期记忆：{} | 详情：{}',
    'experience.status_changed': '已移动到：{}',
    'experience.deleted': '已删除该拒绝项。',
    'experience.delete_confirm_title': '删除拒绝项',
    'experience.delete_confirm_text': '确定永久删除这条已拒绝经验吗？\n\n{}',
    'experience.promote_failed': '晋升失败: {}',
    'experience.open_failed': '打开失败: {}',
    'experience.field_status': '状态',
    'experience.field_created': '创建时间',
    'experience.field_session': '会话 ID',
    'experience.field_signal': '信号类型',
    'experience.field_category': '分类',
    'experience.field_confidence': '置信度',
    'experience.field_quality': '质量分',
    'experience.field_memory': '记忆 ID',
    'experience.field_detail': '详情文件',
    'experience.sec_decision': '晋升判断',
    'experience.sec_rule': '晋升后写入',
    'experience.sec_summary': '经验摘要',
    'experience.sec_evidence': '证据与依据',
    'experience.sec_context': '去噪上下文',

    # ===== Plan / Ask Cards =====
    'plan.title': '计划',
    'plan.planning': '规划中...',
    'plan.generating_steps': '  ⋯ 正在生成步骤...',
    'plan.generating_architecture': '  ⋯ 正在生成架构...',
    'plan.architecture': '架构',
    'plan.flow': '流程',
    'plan.expand': '▸ 展开',
    'plan.collapse': '▾ 收起',
    'plan.complexity': '复杂度',
    'plan.est_operations': '预计操作数',
    'plan.tools': '工具',
    'plan.expected': '预期',
    'plan.fallback': '回退',
    'plan.note': '备注',
...
_EN = {
    ...
    'input.resize.tooltip': 'Drag to resize the input box; double-click to restore auto height',
    'mode.agent': 'Agent',
    'mode.ask': 'Ask',
    'mode.plan': 'Plan',
    ...
    'status.no_reply': 'No reply received.',
    ...
    'btn.undo': 'undo',
    'btn.keep': 'keep',
    'btn.undo_all': 'Undo All',
    'btn.keep_all': 'Keep All',
    'btn.send': 'Send',
    'btn.stop': 'Stop',
    'btn.clear': 'Clear',
    ...
    'menu.attach_actions': 'Attach / Actions',
    'menu.attach_image': 'Attach Image',
    'menu.read_network': 'Read Network',
    'menu.read_selection': 'Read Selection',
    'menu.export_train': 'Export Train',
    ...
    'custom.info': 'Configure any endpoint compatible with the OpenAI API protocol.\nExamples: LM Studio, vLLM, Text Generation WebUI, or other proxies.',
    'custom.url_placeholder': 'https://integrate.api.nvidia.com/v1 or .../v1/chat/completions',
    'custom.key_placeholder': 'sk-xxxx (leave empty to skip the Authorization header)',
    'custom.fetch_models': 'Fetch available models from the API',
    'custom.add_model': 'Add model manually',
    'custom.remove_model': 'Delete selected model',
    'custom.models': 'Models:',
    'custom.context_length': 'Context length:',
    'custom.features': 'Features:',
    'custom.supports_vision': 'Supports image input',
    'custom.supports_fc': 'Supports Function Calling',
    'custom.test': 'Test Connection',
    'custom.need_url': '⚠ Please enter an API URL first',
    'custom.need_url_plain': 'Please enter an API URL first.',
    'custom.need_model': 'Please enter at least one model name.',
    'custom.fetching_models': 'Fetching model list...',
    'custom.models_found': '✅ Found {} models',
    'custom.no_models': '⚠ No available models found',
    'custom.connecting': 'Connecting...',
    'custom.connect_ok': '✅ Connected ({})',
    'dialog.notice': 'Notice',

    # ===== Clear Chat =====
    'clear.confirm_title': 'Clear Current Chat',
    'clear.confirm_msg': 'This will clear the current chat history, context, token stats, pending operations, and delete this session cache.\n\nContinue?',
    'clear.confirm_running_msg': 'This chat is still running. Clearing will stop the task first, then delete the current chat history and cache.\n\nContinue?',
    'clear.empty': 'Current chat is already empty',
    ...
    # ===== Experience Review =====
    'experience.menu_label': 'Workflow Experience',
    'experience.title': 'Workflow Experience Review',
    'experience.subtitle': 'Reusable knowledge is distilled from task context automatically, then promoted only after review.',
    'experience.always_on': 'Auto capture on',
    'experience.extract': 'Extract Current Chat',
    'experience.export_curated': 'Export Curated',
    'experience.export_curated_title': 'Export Curated Experiences',
    'experience.export_curated_failed': 'Failed to export curated experiences: {}',
    'experience.export_curated_done': 'Curated experiences exported: {} semantic, {} strategies\n{}',
    'experience.refresh': 'Refresh',
    'experience.scope_all': 'All Sessions',
    'experience.scope_current': 'Current Session',
    'experience.show_rejected': 'Show Rejected',
    'experience.queue_title': 'Candidate Queue',
    'experience.queue_meta': 'Showing {} item(s) | Filter: {}',
    'experience.board_summary': 'Loaded {} | Candidates {} | Suggested {} | Promoted {} | Rejected {} | Later {}',
    'experience.promote': 'Promote',
    'experience.reject': 'Reject',
    'experience.delete_rejected': 'Delete',
    'experience.later': 'Later',
    'experience.filter_active': 'Active',
    'experience.filter_candidate': 'Candidates',
    'experience.filter_later': 'Later',
    'experience.filter_promoted': 'Promoted',
    'experience.filter_rejected': 'Rejected',
    'experience.filter_all': 'All',
    'experience.status_candidate': 'Candidate',
    'experience.status_later': 'Later',
    'experience.status_promoted': 'Promoted',
    'experience.status_rejected': 'Rejected',
    'experience.empty_title': 'No Candidate Selected',
    'experience.empty': 'No experience candidates yet. Candidates are captured automatically after tasks, or you can extract the current chat manually.',
    'experience.no_history': 'This chat has no conversation history to extract.',
    'experience.extracted': 'Experience candidate created.',
    'experience.extracted_count': '{} experience candidate(s) created.',
    'experience.promoted': 'Promoted to long-term memory.\n\nMemory ID: {}\nDetail: {}',
    'experience.promoted_inline': 'Promoted to long-term memory: {} | Detail: {}',
    'experience.status_changed': 'Moved to: {}',
    'experience.deleted': 'Rejected item deleted.',
    'experience.delete_confirm_title': 'Delete Rejected Item',
    'experience.delete_confirm_text': 'Permanently delete this rejected experience?\n\n{}',
    'experience.promote_failed': 'Promotion failed: {}',
    'experience.open_failed': 'Open failed: {}',
    'experience.field_status': 'Status',
    'experience.field_created': 'Created',
    'experience.field_session': 'Session ID',
    'experience.field_signal': 'Signal Type',
    'experience.field_category': 'Category',
    'experience.field_confidence': 'Confidence',
    'experience.field_quality': 'Quality',
    'experience.field_memory': 'Memory ID',
    'experience.field_detail': 'Detail File',
    'experience.sec_decision': 'Promotion Decision',
    'experience.sec_rule': 'Promoted Rule',
    'experience.sec_summary': 'Experience Summary',
    'experience.sec_evidence': 'Evidence',
    'experience.sec_context': 'Clean Context',

    # ===== Plan / Ask Cards =====
    'plan.title': 'Plan',
    'plan.planning': 'Planning...',
    'plan.generating_steps': '  ⋯ generating steps...',
    'plan.generating_architecture': '  ⋯ generating architecture...',
    'plan.architecture': 'Architecture',
    'plan.flow': 'Flow',
    'plan.expand': '▸ Expand',
    'plan.collapse': '▾ Collapse',
    'plan.complexity': 'Complexity',
    'plan.est_operations': 'Est. Operations',
    'plan.tools': 'Tools',
    ...
    'plan.status.streaming': 'STREAMING',
